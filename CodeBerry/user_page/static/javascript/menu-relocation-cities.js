...
(function ($, window, document) {
    ...
    // constructor
    var RelocationCitiesMenu = function ($element, options) {
    ...
    // plugin prototype
    RelocationCitiesMenu.prototype = {
                ...
                $(document).click(function (event) {
                    ...
                    $('.sol-active')
                        ...
                        .each(function (index, item) {
                            $(item)
                                .data(RelocationCitiesMenu.prototype.DATA_KEY)
                                .close();
                        });
                });
    ...
    RelocationCitiesMenu.defaults = RelocationCitiesMenu.prototype.defaults;
    window.RelocationCitiesMenu = RelocationCitiesMenu;

    $.fn.RelocationCitiesMenu = function (options) {
        var result = [];
        this.each(function () {
            var $this = $(this),
                $alreadyInitializedSol = $this.data(RelocationCitiesMenu.prototype.DATA_KEY);

            if ($alreadyInitializedSol) {
                result.push($alreadyInitializedSol);
            } else {
                var newSol = new RelocationCitiesMenu($this, options);
                result.push(newSol);
